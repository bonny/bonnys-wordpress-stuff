...
define("EP_DEV_IS_PUBLIC", (strpos($_SERVER["HTTP_HOST"], "-dev.earthpeople.se") !== false) || (strpos($_SERVER["HTTP_HOST"], ".urtp.pl") !== false));
define("EP_DEV_IS_LOCAL", ($_SERVER["SERVER_ADDR"] === "127.0.0.1"));
define('WP_LOCAL_DEV', (EP_DEV_IS_LOCAL || EP_DEV_IS_PUBLIC) ? true : false);

// Determine if we are calling using wp cli
define('EP_IS_WP_CLI', "cli" === php_sapi_name());
